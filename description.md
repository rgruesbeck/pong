...
One of the earliest video games is still popular today, and this template makes it easy to create one (or many) of your own without having to learn a complicated framework. This template gives you a complete scaffold to start building right away.

## Visual Customization Controls (VCC's)
- 🎮 Customize game settings.
- 🖼️ Customize paddle, ball, and backgrounds.
...
## Some Ideas
- Pong with warping ball.
- Turn it into doge-ball.
